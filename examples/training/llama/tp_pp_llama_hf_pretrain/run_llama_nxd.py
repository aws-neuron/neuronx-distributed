...
def train_llama(args):
    ...
    nxd_config = nxd.neuronx_distributed_config(
        ...
        activation_checkpoint_config=selective_activation_checkpointing_modules if args.use_selective_checkpoint > 0 else "full",
    ...
    if tag != "-1":
        ...
        if user_content is not None:
            ...
            resume_epoch = user_content["epoch"]
            epoch = resume_epoch
    ...
    if args.async_checkpoint_saving:
