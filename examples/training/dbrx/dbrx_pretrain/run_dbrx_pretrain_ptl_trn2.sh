...
MIN_LR=3.0e-5
# model path
MODEL_PATH=$SCRIPT_DIR/configs/small_scale.json
# data path
DATA_PATH="/home/ubuntu/aahila/examples_datasets/wikicorpus_llama2_tokenized_4k"
# sequence length
SEQ_LEN=4096
# capacity factor
CAPACITY_FACTOR=2.0
...
# Set NUM_NEURONCORES based on vnc_size
if [ "$vnc_size" -eq 1 ]; then
	NUM_NEURONCORES=128
else
	NUM_NEURONCORES=64
fi

# Export NUM_NEURONCORES
export NUM_NEURONCORES
