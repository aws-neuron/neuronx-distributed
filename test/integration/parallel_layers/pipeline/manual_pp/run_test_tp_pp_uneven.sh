...
exec_file=test_training_tp_pp.py
torchrun --nnodes=1 --nproc-per-node=32 --master_port=1234 ${exec_file} --pp-size 4 --tp-size 2 --uneven-partition 2>&1 | tee ${exec_file}-uneven_partition.log