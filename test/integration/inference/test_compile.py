...
class TestCompile(unittest.TestCase):
    ...
    def test_compile_basic(self):
        ...
        trace_artifacts = trace(self.model, args=input_tensor, preserve_parameters=False)
    ...
    def test_compile_complex_model(self):
        ...
        model = ComplexModel()
        input_tensor = torch.randn(3, 10)
        trace_artifacts = trace(model, args=input_tensor, preserve_parameters=False)
        compilation_artifacts = compile(
            hlo_module=trace_artifacts.hlo,
            metaneff=trace_artifacts.metaneff,
        )
    ...
    def test_compile_with_multiple_inputs(self):
        ...
        trace_artifacts = trace(model, args=input_tensors, preserve_parameters=False)
        compilation_artifacts = compile(
            hlo_module=trace_artifacts.hlo,
            metaneff=trace_artifacts.metaneff,
        )
