...
class TestCheckpoint(unittest.TestCase):
    def test_validate_traceable(self):
        try:
            ...
            model_over_vocab = lambda: (Model(shard_across_embedding=False), {})
            model_over_embed = lambda: (Model(shard_across_embedding=True), {})
            ...
            model_over_vocab = lambda: (ModelWithChildren(shard_across_embedding=False), {})
            model_over_embed = lambda: (ModelWithChildren(shard_across_embedding=True), {})
